...
- 对照与引用者：TD-MPC2 走"latent + 规划 + value、不重建"的路线（见 TD-MPC2（arXiv:2310.16828））；DINO-WM / V-JEPA 2 把 Dreamer 系列当离线 / 仿真 baseline（见 dino-wm、vjepa2）；WM-to-WAM-教程、综述 arXiv:2605.00080 把这条线归为 state-space latent WM。
